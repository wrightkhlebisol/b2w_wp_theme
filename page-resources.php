        ...
        <div id="content" class="col-sm-12">
            ...
            <section class="main-content">
                ...
                <div class="resource-row clearfix">
                    <div class="resource">
                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/justhost-logo.jpg" alt="Justhost">
                    ...
                    <div class="resource">
                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/coda2-logo.jpg" alt="Coda 2">
                    ...
                    <div class="resource">
                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/dropbox-logo.jpg" alt="Dropbox">
