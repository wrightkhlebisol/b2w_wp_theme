	...
	<article>
		<div class="container clearfix">
			<div class="row">
				...
				<div class="col-sm-5">
					<img src="wp-content/themes/bootstrap_2_wordpress/assets/img/logo-badge.png" alt="Bootstrap to Wordpress" class="logo">
				</div><!-- col -->
...
<section id="boost-income">
	<div class="container">
		...
		<div class="section-header">
			<img src="wp-content/themes/bootstrap_2_wordpress/assets/img/icon-boost.png" alt="Chart">
...
<section id="who-benefits">
	<div class="container">
		...
		<div class="section-header">
			<img src="wp-content/themes/bootstrap_2_wordpress/assets/img/icon-pad.png" alt="Pad and pencil">
...
<section id="course-features">
	<div class="container">
		...
		<div class="section-header">
			<img src="wp-content/themes/bootstrap_2_wordpress/assets/img/icon-rocket.png" alt="Rocket">
		...
		<div class="row">
			...
			<div class="col-sm-8 col-sm-offset-2">
				...
				<div class="row testimonial">
					<div class="col-sm-4">
						<img src="wp-content/themes/bootstrap_2_wordpress/assets/img/brennan.jpg" alt="Brennan">
					</div><!-- end col -->
					<div class="col-sm-8">
						<blockquote>
				...
				<div class="row testimonial">
					<div class="col-sm-4">
						<img src="wp-content/themes/bootstrap_2_wordpress/assets/img/ben.png" alt="Illustration of a man with a moustache">
					</div><!-- end col -->
					<div class="col-sm-8">
						<blockquote>
				...
				<div class="row testimonial">
					<div class="col-sm-4">
						<img src="wp-content/themes/bootstrap_2_wordpress/assets/img/aj.png" alt="Illustration of a man with a beard">
					</div><!-- end col -->
					<div class="col-sm-8">
						<blockquote>
				...
				<div class="row testimonial">
					<div class="col-sm-4">
						<img src="wp-content/themes/bootstrap_2_wordpress/assets/img/ernest.png" alt="Illustration of a man with a goatee">
					</div><!-- end col -->
					<div class="col-sm-8">
						<blockquote>
